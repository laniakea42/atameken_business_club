...
$(function(){
    ...
    $('.btnreg29').on('click', function() {
        $('.ycard__type2').removeClass('active');
        $('.body29').addClass('active');
        $('.body29').prev().attr('checked', 'checked');
        $('#tabs-b2').css({'display': 'none'})

    });

    $('.btnreg22').on('click', function() {
        $('.body29').removeClass('active');
        $('.body22').addClass('active');
        $('.body29').prev().removeAttr('checked');
        $('.body22').prev().attr('checked', 'checked');
        $('#tabs-b2').css({'display': 'table'}, {'width': '100%'})
    })
